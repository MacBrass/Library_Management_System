...
<head>
    ...
    <meta name="description" content="St. Andrew's College Library Management System - Digital Library Portal">
    <title><?php echo isset($page_title) ? htmlspecialchars($page_title) . ' | ' : ''; ?>St. Andrew's Library</title>
